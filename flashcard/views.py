...
def deletar_flashcard( request,id):
    ...
    if flashcard.user  == request.user:
        ...
        messages.add_message( request, constants.ERROR, 'Nao foi possivel eliminar pos o flashcard selecionado nao te pertence.')
        return redirect(reverse('novo_flashcard'))
...
def iniciar_desafio(request):
    if request.method == 'GET':
        ...
        if flashcards.count() < int(qtd_perguntas):
            messages.add_message(request, constants.ERROR, 'Quantidade de questoes selecinada e maior em relacao aos flashcards existentes que satisfacam os filtros ')
